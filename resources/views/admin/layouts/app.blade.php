...
<head>
    ...
    <title>@yield('title', 'Dashboard') — ubsiStore Admin</title>
    ...
    <style>
        ...
        *::after {
        ...
        .sidebar-brand-text .store-name {
            font-size: 15px;
            font-weight: 700;
            color: var(--text-primary);
        }

        .sidebar-brand-text .store-sub {
            font-size: 11px;
    ...
    <aside class="sidebar" id="sidebar">
        <a href="{{ route('admin.dashboard') }}" class="sidebar-brand">
            ...
            <div class="sidebar-brand-text">
                <div class="store-name">ubsiStore</div>
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('admin.stock-movements.index') }}"
                ...
                <span class="icon">📈</span> Mutasi Stok
            </a>
            ...
            <a href="{{ route('admin.expeditions.index') }}"
                ...
                <span class="icon">🚚</span> Ekspedisi
            </a>
